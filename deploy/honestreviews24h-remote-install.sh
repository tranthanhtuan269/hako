...
APP_DIR="/var/www/honestreviews24h"
DB_NAME="honestreviews24h"
DB_USER="honestreviews24h"
DB_PASS="${DB_PASS:?DB_PASS required}"
DOMAIN="honestreviews24h.com"
GIT_BRANCH="coupontracer"
GIT_REPO="https://github.com/tranthanhtuan269/hako.git"
ADMIN_EMAIL="admin@honestreviews24h.com"
ADMIN_PASS="honestreviews24h.com@"
...
ln -sf "${NGINX_SITE}" /etc/nginx/sites-enabled/honestreviews24h
