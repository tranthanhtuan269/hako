...
APP_DIR="/var/www/ilikereview"
DB_NAME="ilikereview"
DB_USER="ilikereview"
DB_PASS="${DB_PASS:?DB_PASS required}"
DOMAIN="ilikereview.com"
GIT_BRANCH="coupontracer"
GIT_REPO="https://github.com/tranthanhtuan269/hako.git"
ADMIN_EMAIL="admin@ilikereview.com"
ADMIN_PASS="ilikereview.com@"
...
NGINX_SITE="/etc/nginx/sites-available/ilikereview"
...
ln -sf "${NGINX_SITE}" /etc/nginx/sites-enabled/ilikereview
