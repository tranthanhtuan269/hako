...
@section('meta_description', 'Contact ' . config('site.name') . ' for partnership inquiries, coupon submissions, or support. We respond to U.S. shoppers and publishers.')
@section('canonical', route('pages.contact'))

@section('content')
@if(($activeTheme ?? '') === 'googlycodes')
    @include('themes.googlycodes.contact')
@else
<div class="page-hero">
    <div class="container">
        <h1>Contact Us</h1>
        <p class="page-subtitle">We typically respond within 2–3 business days.</p>
    </div>
</div>
